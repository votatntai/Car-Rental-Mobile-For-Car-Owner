...
class CarOwnerWalletView extends StatefulWidget {
  const CarOwnerWalletView({super.key});

  @override
  State<CarOwnerWalletView> createState() => _CarOwnerWalletViewState();
}

class _CarOwnerWalletViewState extends State<CarOwnerWalletView> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CarOwnerWalletBloc, CarOwnerWalletState>(
