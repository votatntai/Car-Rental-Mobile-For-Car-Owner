...
part 'driver_notification_bloc.freezed.dart';

class DriverNotificationBloc
    extends Bloc<DriverNotificationEvent, DriverNotificationState> {
  DriverNotificationBloc({
  ...
  FutureOr<void> _onStared(
    _Started event,
    Emitter<DriverNotificationState> emit,
  ) async {}
