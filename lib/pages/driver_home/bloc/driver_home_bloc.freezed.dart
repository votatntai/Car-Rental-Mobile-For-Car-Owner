...
mixin _$DriverHomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Order> currentOrders, List<Order> historyOrders)
        success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Order> currentOrders, List<Order> historyOrders)?
        success,
...
abstract class _$$_SuccessCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Order> currentOrders, List<Order> historyOrders});
}
...
class _$_Success implements _Success {
  const _$_Success(
      ...
      required final List<Order> historyOrders})
  ...
  @override
  String toString() {
    return 'DriverHomeState.success(currentOrders: $currentOrders, historyOrders: $historyOrders)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(currentOrders, historyOrders);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(currentOrders, historyOrders);
  }
...
abstract class _Success implements DriverHomeState {
  const factory _Success(
      {required final List<Order> currentOrders,
      required final List<Order> historyOrders}) = _$_Success;
